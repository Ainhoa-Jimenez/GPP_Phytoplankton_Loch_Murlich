...
png("Plankton_treatment_barchart.png", width=480, height=480)
...
png("Plankton_Site.png", width=480, height=480)
...
# Bcckground Statistical Analysis
...
png("temp_site.png", width=480, height=480)
...
png("temp_site_day.png", width=480, height=480)
...
png("background_condition.png", width = 480, height=480)
...
np.gpp.t_m # says if significant
...
png("GPP_treatment.png", width = 480, height=480)

data_GPP%>%
  ggplot(aes(treatment, GPP.thu_mon.))+
  geom_boxplot(color="black", fill="#00008B", alpha=0.8)+
  theme_classic()+
  xlab("Treatment")+
...
npp.P <- data_GPP%>%
  ggplot(aes(treatment, NPP.thu_mon.))+
...
r.P <- data_GPP%>%
  ggplot(aes(treatment, R.thu_mon.))+
  geom_boxplot(color="black", fill="grey", alpha=0.8)+
  theme_classic()+
  xlab("Treatment")+
